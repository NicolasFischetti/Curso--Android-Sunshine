...
public class FakeDataUtils {
    ...
    private static ContentValues createTestWeatherContentValues(long date) {
        ...
        testWeatherValues.put(WeatherEntry.COLUMN_WIND_SPEEDLE, Math.random()*10);
        testWeatherValues.put(WeatherEntry.COLUMN_WEATHER, weatherIDs[(int)(Math.random()*10)%5]);
